defmodule Rebel.Module do
  ...
  @callback transform_socket(socket :: Phoenix.Socket.t, payload :: list, state :: Rebel.t) :: list

  defmacro __using__(_opts) do
    quote do
      @behaviour Rebel.Module
