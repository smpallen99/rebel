defmodule Rebel.Element do
  ...
  Example:
      iex> query socket, "a"
      {:ok,
       %{"[rebel-id='13114f0a-d65c-4486-b46e-86809aa00b7f']" => %{
             "attributes" => %{"rebel-id" => "13114f0a-d65c-4486-b46e-86809aa00b7f",
             "href" => "http://tg.pl"}, "classList" => [], "className" => "",
           "dataset" => %{}, "rebel_id" => "13114f0a-d65c-4486-b46e-86809aa00b7f",
  ...
  * `{:ok, map}` - where the `map` contains queried elements.
    ...
    of `"#id"`, otherwise Rebel declares the `rebel-id` attribute and the key became `"[rebel-id='...']"`.
  ...
  * `{:error, message}` - the browser could not be queried
  ...
  Examples:
      ...
      {:ok,
       %{"#begin" => %{"id" => "begin"}, "#rebel_pid" => %{"id" => "rebel_pid"},
         "[rebel-id='472a5f90-c5cf-434b-bdf1-7ee236d67938']" => %{"id" => ""}}}
  ...
  defp query_js(selector, properties) do
    "Rebel.query(#{encode_js(selector)}, #{encode_js(properties)})"
  end
  ...
  defp set_js(selector, properties) do
    "Rebel.set_prop(#{encode_js(selector)}, #{encode_js(properties)})"
  end
